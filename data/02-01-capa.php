...
<!--[if gt IE 8]><!--> <html lang="pt-br" dir="ltr" class="no-js cover curso-tecnologia"> <!--<![endif]-->
	<head>
		<style type="text/css">
			.cover {
  				background-image: url(dist/img/un02/cover--lg.jpg)
			}
		</style>
	...
	<body class="cover" onload="iniciaNavegacao()" onunload="encerraNavegacao()" onbeforeunload="encerraNavegacao()" style="padding:0;">
	<!-- <body class="cover" onunload="encerraNavegacao()" onbeforeunload="encerraNavegacao()" style="padding:0;"> -->
		<!--[if lt IE 7]>
			...
			<main class="course-details">
				<div class="row course-details__container">
					<div class="col-xs-22 col-xs-offset-1 col-sm-20 col-sm-offset-2 col-md-22 col-md-offset-1">
						<h2 class="course-details__unit">Ciência de Dados</h2>				
						<h1 class="course-details__name">Intermediário em Ciência de Dados</h1>
					</div>
				</div>

				<div class="row course-details__container">
					<div class="col-xs-22 col-xs-offset-1 col-sm-20 col-sm-offset-2 col-md-22 col-md-offset-1">
						<h4 class="course-details__unit">Unidade 2</h2>				
						<h3 class="course-details__name">Pré-processamento de dados</h1>
					</div>
				</div>
		...
		<footer class="row cover-footer">
			...
			<div class="col-xs-22 col-sm-8 col-md-10 col-lg-10 cover-footer__cta">
				<a href="02-02-guia-de-estudos.php" title="Selecione para começar">Começar!</a>
			</div>
		</footer>
