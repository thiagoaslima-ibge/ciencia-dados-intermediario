<?php
	// Titulo da unidade
	$moduleTitle = "Agilidade decisória";
	// Titulo do topico
	$topicTitle = "Prática cotidiana";
	// Titulo da pagina	
	$pageTitle = "Página de conteúdo";
...
<main class="page-content okgo">
	...
	<!-- Conteudo da pagina [inicio] -->
		<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">			
			<h2 class="no-top-margin">Direções preferenciais</h2>
		...
		<section class="feature feature--example">
			<div class="col-xs-22 col-xs-offset-1 col-sm-18 col-sm-offset-3 col-md-14 col-md-offset-5 col-lg-10 col-lg-offset-7">
				...
				<p>Nunca é demais lembrar o peso e o significado destes problemas, uma vez que a determinação clara de objetivos cumpre um papel essencial na formulação das novas proposições. Todavia, a valorização de fatores subjetivos aponta para a melhoria das diversas correntes de pensamento.</p>
			</div>
		</section>
		<!-- Destaque [fim] -->
...
<span>});</code></pre>
			...
			<h5>Valorização de fatores subjetivos e incentivo ao avanço tecnológico (h5)</h5>
				<table class="table">
					...
					<thead>
						<tr>
							<th scope="col">Relatividade do sistema</th>
							<th class="table__numeric-col-heading" scope="col">Participação geral</th>
							<th class="table__numeric-col-heading" scope="col">Pontos críticos</th>
							<th class="table__numeric-col-heading" scope="col">Diretrizes de desenvolvimento</th>
						</tr>
					</thead>
					<tbody>
						<tr>
			...
			<div class="table-container">
				<table class="table table--text-table">
					<caption class="table__title">Exemplo de quadro</caption>
					<thead>
						<tr>
							<th scope="col">Diretrizes de desenvolvimento</th>							
							<th scope="col">Participação geral</th>
							<th scope="col">Relatividade do sistema</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th scope="row">Soluções ortodoxas</th>
							<td>O empenho em analisar a adoção de políticas descentralizadoras cumpre um papel essencial na formulação das formas de ação.</td>
							<td>O que temos que ter sempre em mente é que a mobilidade dos capitais internacionais exige a precisão e a definição do processo.</td>
						</tr>
						<tr>
							<th scope="row">Modelo estrutural</th>
							<td>A prática cotidiana prova que a estrutura atual da organização garante a contribuição de um grupo importante.</td>
							<td>O empenho em analisar a adoção de políticas descentralizadoras cumpre um papel essencial na formulação das formas de ação.</td>						
						</tr>
						<tr>
							<th scope="row">Gerenciamento das posturas</th>
							<td>O que temos que ter sempre em mente é que a mobilidade dos capitais internacionais exige a precisão e a definição do processo.</td>	
							<td>A prática cotidiana prova que a estrutura atual da organização garante a contribuição de um grupo importante.</td>						
						</tr>
					</tbody>
		...
		<div class="col-xs-22 col-xs-offset-1 col-sm-20 col-sm-offset-2 col-md-16 col-md-offset-4 col-lg-12 col-lg-offset-6">
			<ul class="panel-slider slider">
				<li>
					<p>A prática cotidiana prova que o consenso sobre a necessidade de qualificação nos obriga à análise do sistema de formação de quadros que corresponde às necessidades. Assim mesmo, a consulta aos diversos militantes apresenta tendências no sentido de aprovar a manutenção das posturas dos órgãos dirigentes com relação às suas atribuições. Desta maneira, a contínua expansão de nossa atividade maximiza as possibilidades por conta dos níveis de motivação departamental. O que temos que ter sempre em mente é que a estrutura atual da organização afeta positivamente a correta previsão dos índices pretendidos. Do mesmo modo, o novo modelo estrutural aqui preconizado garante a contribuição de um grupo importante na determinação da gestão inovadora da qual fazemos parte.</p>
				</li>
				<li>
					<p>Nunca é demais lembrar o peso e o significado destes problemas, uma vez que o desafiador cenário globalizado oferece uma interessante oportunidade para verificação das condições financeiras e administrativas exigidas. Acima de tudo, é fundamental ressaltar que o acompanhamento das preferências de consumo cumpre um papel essencial na formulação das regras de conduta normativas. É claro que a competitividade nas transações comerciais pode nos levar a considerar a reestruturação dos paradigmas corporativos. O incentivo ao avanço tecnológico, assim como o julgamento imparcial das eventualidades representa uma abertura para a melhoria dos procedimentos normalmente adotados.</p>
				</li>
				<li>
				...
				<li>
					<p>Percebemos, cada vez mais, que a necessidade de renovação processual promove a alavancagem dos relacionamentos verticais entre as hierarquias. A nível organizacional, a revolução dos costumes exige a precisão e a definição do retorno esperado a longo prazo. No mundo atual, a determinação clara de objetivos possibilita uma melhor visão global do fluxo de informações. Neste sentido, o comprometimento entre as equipes estimula a padronização do levantamento das variáveis envolvidas.</p>
				</li>
			</ul>
		</div>
		<!-- Carrossel [fim] -->
...
<script>
	...
	$('.page-content').scroll(function () { AOS.refresh(); });// Rodar Animate-On-Scroll quando for acionada a barra de rolagem	
	...
	L.marker([-22.912161949999998,-43.23117510590559], {icon: marker}).addTo(mymap) // Designacao do popip
		.bindPopup("<b>Olá</b>, eu sou um <a href='http://www.ibge.gov.br' target='_blank'>popup</a>.")
		.openPopup();
	L.marker([-30.0655321,-51.23631893507668], {icon: marker}).addTo(mymap) // Designacao do tooltip
